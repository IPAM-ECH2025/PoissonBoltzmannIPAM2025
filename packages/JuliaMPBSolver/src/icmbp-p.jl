...
# ╔═╡ e073bc4e-b152-4612-b350-8c22c38b8e80
const iϕ=1
...
function bcondition!(y, u, bnode, data)
  boundary_neumann!(y, u, bnode, species = iϕ, region = 2, value = data.q[2])
  boundary_neumann!(y, u, bnode, species = iϕ, region = 1, value = data.q[1])
