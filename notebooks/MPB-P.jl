...
begin
    ...
    using PythonPlot
    using Colors
    using JuliaMPBSolver.ICMPBP: ICMPBData, ICMPBSystem, L_Debye, set_molarity!, dlcap0, DerivedData, apply_charge!, ysum
end
...
begin
    ...
    sol1 = solve!(VoronoiFVM.SystemState(sys, data=data1), verbose = "n", damp_initial = 0.1)
end
